...
import FloatingSearchField, {FloatingSearchFieldContext} from '../../components/Page/FloatingSearchField'

export default () => {
    const [seachPane, setSearchPane] = useState(false)
    ...
    return (
        <header>
            <SideBar>
                ...
                <FloatingSearchFieldContext.Provider value = {[seachPane, setSearchPane]}>
                    <div className = 'container px-4'>
                        <div className = 'user-select-0 row py-4 px-3 j-c-space-between a-i-c po-rel'>
                            <FloatingSearchField />
                            ...
                            <div className = ''>
                                <div className="d-inline-block px-4 po-rel">
                                    <div className="flex-h a-i-c ttt-parent rounded-2x">
                                        <div onClick = {() => setSearchPane(true)} className = 'ttt cursor-pointer'>
                                        ...
                                        <div>{(
                                            ...
                                            ? cart.map(
                                                ({name, price, quantity, image, id}) => (
                                                    <div key = {id} className="flex-h border-bottom a-i-c px-3 py-4">
                ...
                </FloatingSearchFieldContext.Provider>
